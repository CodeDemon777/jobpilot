...
class GlassdoorScraper(BaseScraper):
    ...
    async def search(self, query: str, location: str = "", **kwargs) -> list[JobListing]:
        ...
        try:
            ...
            for card in soup.select("li.JobsList_jobListItem__wjTH, li[data-test='jobListing']"):
                title_el = card.select_one("a[data-test='job-title'], a.JobCard_jobTitle__GLyJ")
                company_el = card.select_one("a.EmployerProfile_compactEmployerName__LE242, span.EmployerProfile_compactEmployerName__LE242")
                location_el = card.select_one("div[data-test='emp-location'], div.JobCard_location__rCz3x")
                if not title_el:
                    continue
                ...
                jobs.append(JobListing(
                    ...
                    url=job_url, source="glassdoor", tech_stack=skills,
