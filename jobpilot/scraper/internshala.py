...
class InternshalaScraper(BaseScraper):
    ...
    async def search(self, query: str, location: str = "", **kwargs) -> list[JobListing]:
        ...
        try:
            ...
            for card in soup.select("div.job-internship-card, div.individual_internship"):
                ...
                jobs.append(JobListing(
                    company=company, title=title, location=loc or "India",
                    remote_status="remote" if "remote" in loc.lower() else "onsite",
                    employment_type="internship", required_skills=skills,
                    url=job_url, source="internshala", tech_stack=skills,
