    ...
    async def search(self, query: str, location: str = "", **kwargs) -> list[JobListing]:
        ...
        try:
            ...
            for job_data in data.get("jobDetails", []):
                ...
                loc = job_data.get("placeholders", [{}])[0].get("label", "") if job_data.get("placeholders") else ""
                job_url = f"https://www.naukri.com/jobapi/v3/job/{job_data.get('jobId', '')}"
                skills = self._extract_skills(job_data.get("skillDetails", "") or job_data.get("title", ""))
                ...
                jobs.append(JobListing(
                    ...
                    url=job_url, source="naukri", tech_stack=skills,
