...
class CareerRoadmapGenerator:
    ...
    def generate_roadmap(
        self, goal_role: str, goal_company: str = "", user_id: int = 1
    ) -> dict:
        """
        ...
        return {
            ...
            "match_analysis": self._analyze_goal_match(
                goal_role, goal_company, profile
            ),
        }
    ...
    def _generate_roadmap_data(
        ...
        beginner_skills = [
            s for s in missing_skills if s in ["git", "html", "css", "sql", "linux"]
        ]
        intermediate_skills = [
            s
            for s in missing_skills
            if s in ["python", "javascript", "react", "docker", "node.js", "aws"]
        ]
        advanced_skills = [
            s
            for s in missing_skills
            if s in ["kubernetes", "terraform", "spark", "kafka", "pytorch"]
        ]
    ...
    def _get_recommended_resources(self, missing_skills: list) -> list[dict]:
        ...
        resources_map = {
            ...
            "kubernetes": {
                "platform": "Coursera",
                "course": "Google Cloud: Kubernetes",
                "url": "https://www.coursera.org",
            },
            "aws": {
                "platform": "AWS",
            ...
            "terraform": {
                "platform": "HashiCorp",
                "course": "Terraform Associate",
                "url": "https://www.terraform.io/learn",
            },
            "pytorch": {
                "platform": "Coursera",
        ...
        for skill in missing_skills:
            if skill in resources_map:
                resources.append({"skill": skill, **resources_map[skill]})
            else:
                resources.append(
                    {
                        "skill": skill,
    ...
    def _analyze_goal_match(
        self, goal_role: str, goal_company: str, profile: UserProfile
    ) -> dict:
